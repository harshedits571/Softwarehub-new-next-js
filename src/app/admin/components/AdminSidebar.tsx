            ...
            return visibleTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  style={tab.style}
                  className={`w-full text-left px-4 py-2.5 rounded-xl sidebar-link flex items-center gap-3 text-xs font-semibold ${isActive ? "active" : "text-gray-400 hover:text-white"
                    }`}
                >
